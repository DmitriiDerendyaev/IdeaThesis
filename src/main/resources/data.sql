...
-- Добавление данных в таблицу компетенций
...
-- Добавление данных в таблицу областей и тем
...
-- Добавление данных в таблицу результатов генерации тем дипломных работ
...
-- Добавление данных в таблицу ответов
INSERT INTO responses (request_id, topic_id, response_time) VALUES
                                                                (1, 1, CURRENT_TIMESTAMP),
                                                                (2, 2, CURRENT_TIMESTAMP);

-- Добавление данных в таблицу состояний пользователя
